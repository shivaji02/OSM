...
@section('content')
    <div class="card">
        <div class="card-header">
           <h4>{{__('5 Minute Daily Journal/ Meditation')}}</h4>
            <p class="form-text text-info text-xs">
            ...
            <form action="/save-journal" method="post">
                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        <div class="form-group">
                            <label for="exampleFormControlTextarea1">
                                {{__('Write whatever you want to write')}}
                            </label>
                            <p class="form-text text-info text-xs ms-1">
                                {{__('Write about how you feel today,or write whatever you want to write.')}}
                            </p>
                            <textarea class="form-control" name="notes" id="notes" rows="10">@if (!empty($journal)){!! $journal->notes !!}@endif</textarea>
                        </div>
