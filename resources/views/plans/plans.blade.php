...
@section('content')
    <div class=" row">
        ...
        <div class="col text-end">
            <a href="/goal-plans" type="button" class="btn btn-info">{{__('Plan for your goals')}}</a>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-6 my-auto">
                    ...
                    <h4 class="text-info  fw-bolder mt-4">{{__('“A dream without a plan is just a wish.”')}}
                    </h4>
                    <p class="text-info opacity-8 fadeIn3 fadeInBottom">{{__('— Katherine Paterson')}} </p>
                    <p class="text-info">{{__('Our actions and decisions today will shape the way we will be living in the future.')}} </p>
                        ...
                        @foreach($plans as $plan)
                            ...
                            <li class="list-group-item border-0 d-flex p-4 mb-2 mt-3 bg-gray-100 border-radius-lg">
                                <div class="d-flex flex-column">
                                    ...
                                    <span class="text-xs">{{__('Date:')}} <span class="text-dark ms-sm-2 font-weight-bold">{{(\App\Supports\DateSupport::parse($plan->date))->format(config('app.date_format'))}}
                                        </span>
                                    </span>
                                </div>
