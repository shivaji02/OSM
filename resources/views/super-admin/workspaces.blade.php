                ...
                <div class="card card-body  mb-4">
                    <div class="card-body px-0 pt-0 pb-2">
                        <div class="table-responsive p-0">
                            <table class="table table-striped align-items-center mb-0" id="cloudonex_table">
                                <thead>
                                <tr>
                                    ...
                                    <th class="text-center text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">{{__('Account Status')}}</th>
                                ...
                                @foreach($workspaces as $workspace)
                                    <tr>
                                            ...
                                            @if($workspace->id !== $user->workspace_id)
                                                <a class="btn btn-link text-dark px-3 mb-0"
                                                   href="/edit-workspace?id={{$workspace->id}}"><i
                                                            class=" text-dark fas fa-pencil-alt me-2"></i>{{__('Edit')}}
                                                </a>
                                        ...
                                        @if($workspace->id !== $user->workspace_id)
                                                ...
                                                <a class="btn btn-link text-danger text-gradient px-3 mb-0" href="/delete-workspace/{{$workspace->id}}"><i class="far fa-trash-alt me-2"></i>{{__('Delete')}}</a>
