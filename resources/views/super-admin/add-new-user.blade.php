                ...
                <div class="multisteps-form mb-5">
                    ...
                    <div class="row">
                        <div class="col-12 col-lg-8 m-auto">
                            <form action="/user-post"  method="post" class=" mb-8">
                                <!--single form panel-->
                                    ...
                                    <div class="multisteps-form__content">
                                        <div class="row mt-3">
                                            <div class="col-12 col-sm-6">
                                                ...
                                                <input name="first_name" class="multisteps-form__input form-control" type="text" value="{{$selected_user->first_name ?? old('first_name') ?? ''}}" />
                                            </div>
                                            <div class="col-12 col-sm-6 mt-3 mt-sm-0">
                                                <label>{{__('Last Name')}}</label>
                                                <input name="last_name"class="multisteps-form__input form-control" type="text" value="{{$selected_user->last_name ?? old('last_name') ?? ''}}"/>
                                            </div>
                                        </div>
                                        <div class="row mt-3">
                                            <div class="col-md-12">
                                        ...
                                        <div class="row mt-3">
                                            <div class="col-md-12">
                                                ...
                                                <input name="password"  type="password" class="multisteps-form__input form-control"  value=""/>
                                                <p class="text-xs">
