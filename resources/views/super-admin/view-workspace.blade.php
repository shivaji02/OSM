                           ...
                           <div class="card-body">
                               ...
                               <table class="table table-light">
                                   ...
                                   <tr>
                                       ...
                                       <th class="text-uppercase text-secondary text-xxs font-weight-bolder">{{__('Name')}}</th>
                                       <th class="text-uppercase text-secondary text-xxs font-weight-bolder ">{{__('Email')}}</th>
                                       <th class="text-uppercase text-secondary text-xxs font-weight-bolder">{{__('Phone')}}</th>
                                   </tr>
                                   </thead>
                                   <tbody>
