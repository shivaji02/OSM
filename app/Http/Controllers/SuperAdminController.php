...
class SuperAdminController extends SuperAdminBaseController
{
    ...
    public function dashboard()
    {
        ...
        {
            return redirect(config('app.url').'/super-admin/update-schema');
        }
        ...
        $recent_plans = SubscriptionPlan::orderBy('id', 'desc')
            ->limit(5)
            ->get();;
        $workspaces = Workspace::all()->keyBy('id')->all();

        $payment_gateways = PaymentGateway::all()->keyBy('api_name')->all();
    ...
    public function userProfile(Request $request)
    {
        ...
        if($request->id)
        {
            ...
            $focus_user_workspace = Workspace::find($focus_user->workspace_id);

            if($focus_user_workspace->plan_id)
            {
                $plan = SubscriptionPlan::find($focus_user_workspace->plan_id);
            }
        ...
        return \view('super-admin.user-profile',[
            ...
            'focus_user_workspace'=> $focus_user_workspace,
            'plan'=> $plan,
        ]);
    ...
    public function exportSubscribers()
    {
        ...
        $columns = array('Email', 'Created At');
        ...
        $callback = function() use($emails, $columns) {
            ...
            foreach ($emails as $email) {
                ...
                $row['Created At']    = $email->created_at;

                fputcsv($file, array($row['Email'], $row['Created At']));
            }
    ...
    public function feature2Section(Request $request)
    {
        ...
        $request->validate([
            ...
            'feature2_image' => 'nullable|file|mimes:jpg,png',
        ...
        if($request->feature2_image)
        {
            $path = $request->file('feature2_image')->store('media', 'uploads');


        }
        if (!empty($path)) {
            $post->feature2_image = $path;
        }
        ...
        $post->feature2_image_title = $request->feature2_image_title;
        $post->feature2_image_subtitle = $request->feature2_image_subtitle;
    ...
    public function pricingTestimonialSection(Request $request)
    {


        $request->validate([

            'testimonial_image' => 'nullable|file|mimes:jpg,png',
        ...
        {
            $path = $request->file('testimonial_image')->store('media', 'uploads');

        }
        if (!empty($path)) {
            $post->testimonial_image = $path;
        }

        $post->testimonial_title = $request->testimonial_title;
        $post->testimonial_author = $request->testimonial_author;
        $post->testimonial_subtitle = $request->testimonial_subtitle;
        $post->testimonial_paragraph = $request->testimonial_paragraph;
    ...
    public function privacyPage()
    {
        ...
        return \view('super-admin.privacy-page-editor',[
            'selected_navigation' => 'landing-page',
            'selected_sub_navigation' => 'privacy-page-editor',
            'privacy' => $privacy,
    ...
    public function contactPage()
    {
        ...
        return \view('super-admin.contact',[
            'selected_navigation' => 'landing-page',
            'selected_sub_navigation' => 'contact-page-editor',
    ...
    public function contactSection(Request $request)
    {
        ...
        return redirect(config('app.url').'/contactpage');
    ...
    public function termsPage()
    {
        ...
        return \view('super-admin.terms-page-editor',[
            'selected_sub_navigation' => 'terms-page-editor',
            'selected_navigation' => 'landing-page',
            'term' => $term,
